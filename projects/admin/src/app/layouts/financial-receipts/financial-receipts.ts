...
@Component({
  selector: 'app-financial-receipts',
  imports: [FloatLabel, FormsModule, AgGridAngular, InputIcon, IconField, ReactiveFormsModule, InputTextModule],
  templateUrl: './financial-receipts.html',
  styleUrl: './financial-receipts.scss',
})
export class FinancialReceipts implements OnInit, OnDestroy {
