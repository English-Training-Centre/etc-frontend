...
@Component({
  selector: 'app-academic-assessments',
  imports: [FloatLabel, FormsModule, AgGridAngular, InputIcon, IconField, ReactiveFormsModule, InputTextModule, SelectButtonModule],
  templateUrl: './academic-assessments.html',
  styleUrl: './academic-assessments.scss',
})
export class AcademicAssessments implements OnInit, OnDestroy {
